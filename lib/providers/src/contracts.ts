...
export interface VideoProvider {
   ...
   * the supplied tenant space. This is configuration-scoped and never performs
   * network or DNS lookups.
   */
  isPlaybackSourceTrusted(space: TenantSpace, url: string): Promise<boolean>;
