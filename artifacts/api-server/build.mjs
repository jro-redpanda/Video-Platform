...
async function buildAll() {
  ...
  await esbuild({
    entryPoints: [
      ...
      path.resolve(artifactDir, "src/folders-step13-smoke.ts"),
      path.resolve(artifactDir, "src/bulk-video-step14-smoke.ts"),
      path.resolve(artifactDir, "src/thumbnail-step15-smoke.ts"),
      ...
      path.resolve(artifactDir, "src/onboarding-smoke.ts"),
